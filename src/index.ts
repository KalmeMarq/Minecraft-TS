...
const initialize = async () => {
  ...
  async function fetchAllData() {
    widgetsImg.src = './dist/resources/assets/minecraft/textures/gui/widgets.png';
    optionsBackgroundImg.src = './dist/resources/assets/minecraft/textures/gui/options_background.png';

    await JSONUtils.getJSONFile('./dist/resources/assets/minecraft/lang/en_us.json', (data: any) => Resources.languages.push(data));
    await JSONUtils.getJSONFile('./dist/resources/assets/minecraft/lang/es_es.json', (data: any) => Resources.languages.push(data));
    await JSONUtils.getJSONFile('./dist/resources/assets/minecraft/lang/fr_fr.json', (data: any) => Resources.languages.push(data));
    await JSONUtils.getJSONFile('./dist/resources/assets/minecraft/lang/pt_pt.json', (data: any) => Resources.languages.push(data));
    
    await JSONUtils.getTextFile('./dist/resources/assets/minecraft/texts/end.txt', (data: any) => data.split(/\r?\n/).forEach((line: any) => Resources.texts.splashes.push(line)));
    await JSONUtils.getTextFile('./dist/resources/assets/minecraft/texts/splashes.txt', (data: any) => data.split(/\r?\n/).forEach((line: any) => Resources.texts.splashes.push(line)));
