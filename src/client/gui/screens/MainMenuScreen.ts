import { scaleFactor, Minecraft, font, ctx, minecraftImg, editionImg, setTicks, Resources, mouseXM, mouseYM, clickXM, clickYM, resetClickXY } from "../../../index.js";
...
export default class MainMenuScreen extends ScreenP {
  ...
  render() {
    ...
    // ctx.font = font;
    let a: any = this.splashText;
    // let splashWidth = FontRenderer.getTextWidth(a.split(''));
